      ...
      <div className="relative max-w-[800px] mx-auto px-5 py-16 text-center md:px-10 md:py-24 lg:px-12 lg:py-28">
        ...
        <div className="entrance" style={{ transitionDelay: '0.2s' }}>
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3">
            ...
            <a
              href="#how-it-works"
              className="inline-flex items-center justify-center border border-white/25 text-white text-base font-semibold px-6 sm:px-8 py-4 transition-colors hover:bg-white/10"
            >
              Wie funktioniert TeilePilot24?
            </a>
          </div>
