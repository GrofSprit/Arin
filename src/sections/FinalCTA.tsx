...
export default function FinalCTA() {
  return (
    <section data-final-cta className="bg-midnight relative overflow-hidden">
      {/* Subtle gradient accent */}
      <div className="absolute inset-0 pointer-events-none" style={{
        background: 'radial-gradient(ellipse 800px 400px at 50% 100%, rgba(67, 97, 238, 0.12), transparent)'
      }} />

      <div className="relative max-w-[800px] mx-auto px-5 py-14 text-center md:px-10 md:py-20 lg:px-12 lg:py-24">
        ...
        <p className="entrance text-base md:text-lg text-white/55 mb-8 max-w-md mx-auto" style={{ transitionDelay: '0.1s' }}>
          Fahrzeugdaten senden und persönliches Angebot erhalten.
        </p>
        <div className="entrance" style={{ transitionDelay: '0.2s' }}>
          <div className="flex items-center justify-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-3 bg-whatsapp text-white text-base md:text-lg font-semibold px-6 sm:px-10 py-4 shadow-lg shadow-whatsapp/20 transition-all duration-200 hover:bg-whatsapp-dark hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98]"
            >
