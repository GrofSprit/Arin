      ...
      <div className="relative z-[1] max-w-[1200px] mx-auto px-5 md:px-10 lg:px-12 pt-40 pb-16 md:pt-44 md:pb-20 lg:pt-40 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          <div className="order-2 lg:order-1">
            <h1 className="hero-entrance animate-hero-headline text-[32px] md:text-[48px] lg:text-[56px] text-white font-semibold mb-5 leading-[1.1] tracking-tight">
              Das passende Ersatzteil finden lassen.
            </h1>
            <p className="hero-entrance animate-hero-desc text-base md:text-lg text-white/60 max-w-lg mb-8 leading-relaxed">
              Senden Sie uns Ihren Fahrzeugschein per WhatsApp. Wir prüfen VIN, OEM-Nummer und Fahrzeugdaten manuell und finden das passende Ersatzteil für Ihr Fahrzeug.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-8">
              <a
                ...
                className="hero-entrance animate-hero-cta1 inline-flex items-center justify-center gap-2.5 bg-whatsapp text-white text-base md:text-lg font-semibold px-6 md:px-8 py-3.5 md:py-4 shadow-lg shadow-whatsapp/20 transition-all duration-200 hover:bg-whatsapp-dark hover:shadow-xl active:scale-[0.97]"
              >
            ...
            {/* Trust badges */}
            <div className="hero-entrance animate-hero-trust flex flex-wrap gap-2">
              {['Kostenlose Anfrage', 'Persönliche Prüfung', 'Rückmeldung meist am selben Tag', 'Für viele Automarken'].map((badge) => (
          ...
          <div className="hidden lg:grid grid-cols-2 gap-3 order-1 lg:order-2">
            ...
            <div className="hero-entrance animate-hero-cta1 bg-white/[0.06] backdrop-blur-sm border border-white/10 p-4 animate-float" style={{ animationDelay: '0s' }}>
              <div className="flex items-center gap-2.5 mb-3">
                ...
                <span className="text-sm text-white/80 font-medium">Fahrzeugschein</span>
              </div>
              <div className="rounded overflow-hidden">
                <img src="/images/fahrzeugschein.jpg" alt="Fahrzeugschein" className="w-full h-24 object-cover" />
              </div>
              <p className="text-xs text-white/40 mt-2">Foto aufnehmen & senden</p>
            </div>
            ...
            <div className="hero-entrance animate-hero-cta2 bg-white/[0.06] backdrop-blur-sm border border-white/10 p-4 animate-float" style={{ animationDelay: '0.5s' }}>
              ...
              <div className="space-y-2">
                ...
                <div className="bg-whatsapp/20 rounded-lg rounded-br-sm px-3 py-2 text-xs text-white/80">Gerne! Bitte Fahrzeugschein senden.</div>
              </div>
            </div>
            ...
            <div className="hero-entrance animate-hero-trust bg-white/[0.06] backdrop-blur-sm border border-white/10 p-4 animate-float" style={{ animationDelay: '1.5s' }}>
              ...
              <p className="text-xs text-white/40 mt-2">Lieferzeit: 2-3 Werktage</p>
            </div>
          </div>
        </div>
      </div>
